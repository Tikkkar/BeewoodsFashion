...
import { ChevronRight, Package, CheckCircle, XCircle, Clock, MapPin, Phone, Video, AlertCircle, Truck } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-700 text-white py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 text-lg">
            Đảm bảo quyền lợi khách hàng - Mua sắm an tâm tại {brand?.name || 'BeeWo'}
          </p>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-900 font-medium">Chính sách đổi hàng</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm leading-relaxed">
                Vui lòng đọc kỹ chính sách đổi hàng trước khi thực hiện. 
                Mọi thắc mắc xin liên hệ hotline: <strong>0978.715.445</strong>
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            <p className="text-gray-700 leading-relaxed">
              Áp dụng đổi hàng trong vòng <strong className="text-black">15 ngày</strong> đối với các sản phẩm:
            </p>
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle size={20} className="text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Bị hư hỏng do lỗi vận chuyển</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle size={20} className="text-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">Lỗi do nhà sản xuất (khâu chỉ, vải, màu sắc...)</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Điều Kiện Đổi Hàng</h2>
          </div>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Trong vòng <strong>15 ngày</strong> kể từ ngày nhận hàng hoặc mua tại cửa hàng {brand?.name || 'BeeWo'}.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-gray-700 space-y-2">
                    ...
                    <li>• Sản phẩm còn nguyên tem (tag giấy, mác dệt {brand?.name || 'BeeWo'})</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-5 hover:border-black transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Tình trạng sản phẩm</h3>
                  <ul className="text-gray-700 space-y-2">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-5 hover:border-black transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">Video unboxing (Quan trọng)</h3>
                  <p className="text-gray-700">
                    <strong className="text-red-600">Bắt buộc</strong> quay lại video khi mở hàng để làm bằng chứng trong trường hợp cần đổi trả.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 bg-red-50 border-l-4 border-red-500 p-5 rounded-r-lg">
            ...
            <ul className="space-y-2 text-red-800 text-sm">
              <li>• Chỉ áp dụng đổi hàng <strong>1 lần duy nhất</strong></li>
              <li>• Giá trị sản phẩm đổi phải <strong>bằng hoặc cao hơn</strong> giá trị đã mua</li>
              <li>• <strong>Không áp dụng</strong> cho các chương trình sale/giảm giá</li>
              <li>• Hàng đã mua <strong>không chấp nhận trả</strong>, chỉ đổi</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Cách Thức Đổi Hàng</h2>
          </div>
            ...
            <ol className="space-y-4">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">Gọi <strong>08 656 444 68</strong> để được tư vấn và xác nhận đổi hàng</p>
                </div>
              </li>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm">Ghi rõ trên kiện hàng:</p>
                ...
                <div>
                  ...
                  <div className="bg-white p-4 rounded-lg border border-gray-300 mt-2">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <div>
                        <p className="font-semibold text-sm">Địa chỉ đổi hàng:</p>
                        <p className="text-gray-700 text-sm">
                          Số 57 ngõ 232 Trần Điền, phường Phương Liệt, Thanh Xuân, Hà Nội
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      <div>
                        ...
                        <a href="tel:0865644468" className="text-blue-600 font-bold hover:underline">
                          08 656 444 68
                        </a>
                      </div>
                    </div>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold mb-1">Chờ xác nhận và nhận hàng mới</p>
                  <p className="text-gray-700 text-sm">
                    Sau khi nhận và kiểm tra hàng, chúng tôi sẽ liên hệ và gửi sản phẩm đổi trong vòng 3-5 ngày làm việc
                  </p>
                </div>
              </li>
            </ol>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Khách hàng thanh toán phí vận chuyển <strong>2 chiều</strong> trong các trường hợp:
              </p>
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-lg">{brand?.name || 'BeeWo'} chịu phí</h3>
              </div>
              <p className="text-gray-700 text-sm leading-relaxed">
                Chúng tôi chịu <strong>toàn bộ phí vận chuyển</strong> trong các trường hợp:
              </p>
              <ul className="mt-3 space-y-2 text-gray-700 text-sm">
        ...
        <section className="bg-gradient-to-r from-black to-gray-800 text-white rounded-lg p-8 md:p-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur rounded-lg p-6 text-center">
              <Phone size={32} className="mx-auto mb-3" />
              <p className="text-sm text-gray-300 mb-2">Hotline phản ánh dịch vụ</p>
              <a href="tel:0978715445" className="text-2xl font-bold hover:text-gray-300 transition">
                0978.715.445
              </a>
          ...
          <p className="text-center text-gray-300 text-sm mt-6">
            Hoặc gửi email: <a href="mailto:support@beewo.vn" className="underline hover:text-white">support@beewo.vn</a>
          </p>
        </section>
