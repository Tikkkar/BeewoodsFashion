            ...
            <div className="border-t pt-6 space-y-5">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold uppercase tracking-wide">Chọn Size</label>
                  <button 
              ...
              <div className="space-y-3">
                <label className="text-sm font-semibold uppercase tracking-wide">Số lượng</label>
              ...
              <div className="space-y-3 pt-4">
                <button
                  ...
                  className={`w-full py-4 rounded-lg font-semibold uppercase tracking-wide transition flex items-center justify-center gap-2 ${
                    product.stock === 0
                        ...
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              <div className="flex">
                                {[...Array(5)].map((_, i) => (
                                  <Star key={i} size={14} className={i < review.rating ? 'fill-yellow-400 text-yellow-400' : 'fill-gray-300 text-gray-300'} />
                                ))}
                              </div>
            ...
            <div className="p-6">
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg text-center">
                <p className="text-sm text-gray-700">
                  Cần tư vấn thêm? Liên hệ hotline: <strong className="cursor-pointer">0983.918.411</strong>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowShippingPolicy(false)}>
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              <p className="text-gray-700">Bạn có thể thanh toán cho người giao hàng mà không cần chịu phí thu tiền hộ (COD).</p>
              <div className="bg-green-50 p-4 rounded-lg space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-gray-700 flex-1">Chúng tôi hỗ trợ <strong>được kiểm tra hàng trước khi thanh toán</strong> nhưng không mặc thử đồ</p>
                </div>
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-gray-700 flex-1">Chúng tôi không gửi đơn hàng COD nếu bạn có đơn hàng khác sử dụng COD mà chưa nhận hàng</p>
                </div>
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-gray-700 flex-1">Người giao hàng (bưu tá) không phải là nhân viên của chúng tôi, vui lòng liên hệ theo số hotline trên bì hàng để được hỗ trợ</p>
                </div>
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-gray-700 flex-1">Sản phẩm đúng với hình ảnh và mô tả nhưng nếu không ưng ý hoặc vì lý do nào khác khiến bạn từ chối nhận hàng, vui lòng hỗ trợ 30.000đ cước phí vận chuyển chiều về qua nhân viên phát hàng</p>
                </div>
              </div>
              <div className="border-t pt-4">
                <p className="text-sm text-gray-600 italic">Rất mong nhận được sự thông cảm và hợp tác từ quý khách hàng! 🙏</p>
              </div>
            </div>
          </div>
        </div>
