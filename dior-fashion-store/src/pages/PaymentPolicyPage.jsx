...
import { ChevronRight, CreditCard, Banknote, Wallet, CheckCircle, AlertCircle, Shield, Phone, ArrowRight } from 'lucide-react';
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-900 font-medium">Chính sách thanh toán</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg mb-10">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-green-900 mb-2">Thanh toán an toàn</h3>
              <p className="text-green-800 text-sm leading-relaxed">
                {brand?.name || 'BeeWo'} hỗ trợ đa dạng phương thức thanh toán để bạn lựa chọn. 
                Mọi giao dịch đều được bảo mật và mã hóa tối đa.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Thanh Toán Bằng Tiền Mặt (COD)</h2>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-xl mb-3">Thanh toán khi nhận hàng</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Quý khách thanh toán trực tiếp cho nhân viên giao hàng khi nhận được sản phẩm. 
                  Đây là phương thức đơn giản, tiện lợi và được nhiều khách hàng lựa chọn.
                </p>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Thanh Toán Bằng Chuyển Khoản</h2>
          </div>
                ...
                <div className="bg-white rounded-lg p-6 border-2 border-blue-300 shadow-md">
                  <div className="space-y-4">
                    <div className="flex justify-between items-start pb-3 border-b">
                      ...
                      <span className="font-bold text-right">NGUYỄN QUANG SẮC</span>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700 mb-2">
                    Vui lòng ghi rõ: <strong>Số điện thoại + Mã đơn hàng</strong>
                  </p>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700">
                    Sau khi nhận được chuyển khoản, chậm nhất sau <strong>12 tiếng</strong> chúng tôi sẽ gọi điện 
                    xác nhận với khách hàng và tiến hành đóng gói, giao hàng.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700">
                    Đơn hàng sẽ được xử lý và giao đến quý khách theo thời gian cam kết trong 
                    <Link to="/shipping-policy" className="text-blue-600 hover:underline ml-1">chính sách giao nhận</Link>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-yellow-800">
                <strong>Lưu ý:</strong> Vui lòng chụp lại màn hình giao dịch và gửi cho chúng tôi qua Zalo/Messenger 
                để được xác nhận nhanh hơn.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Thanh Toán Qua Ví OnePay</h2>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-lg p-6 mb-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-xl mb-3">Thanh toán trực tuyến an toàn</h3>
                <p className="text-gray-700 leading-relaxed">
                  Nhằm mục đích giúp khách hàng thanh toán nhanh chóng, tiện lợi và an toàn khi mua hàng trực tuyến, 
                  {brand?.name || 'BeeWo'} chính thức áp dụng phương thức thanh toán trực tuyến qua cổng <strong>OnePay</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {/* General Steps */}
            <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
              <h4 className="font-bold text-lg mb-4">Các bước thanh toán qua OnePay</h4>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h5 className="font-semibold mb-2">Thêm sản phẩm vào giỏ hàng</h5>
                    <p className="text-sm text-gray-700">
                      Chọn sản phẩm yêu thích, thêm vào giỏ hàng và nhấn <strong>"ĐẶT HÀNG"</strong>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 mb-2">
                      Nhập thông tin cá nhân, địa chỉ nhận hàng, mã giảm giá (nếu có)
                    </p>
                    <p className="text-sm text-gray-700">
                      Chọn một trong hai phương thức:
                    </p>
                    <ul className="text-sm text-gray-700 ml-4 mt-2 space-y-1">
                      <li>• <strong>OnePay Card International</strong> (Thẻ quốc tế)</li>
                      <li>• <strong>OnePay Card Domestic</strong> (Thẻ nội địa)</li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-lg">Hình thức 1: OnePay Card International</h4>
              </div>
              
              <div className="space-y-3">
                <div className="flex gap-3">
                  <span className="text-blue-600 font-bold">→</span>
                  <p className="text-sm text-gray-700">Chọn loại thẻ sử dụng để thanh toán (Visa, Mastercard, JCB...)</p>
                </div>
                
                <div className="flex gap-3">
                  <span className="text-blue-600 font-bold">→</span>
                  <p className="text-sm text-gray-700">Nhập các thông tin thẻ theo yêu cầu và chọn <strong>"Xác nhận thanh toán"</strong></p>
                </div>
                
                <div className="flex gap-3">
                  <span className="text-blue-600 font-bold">→</span>
                  <p className="text-sm text-gray-700">OTP đã được gửi về số điện thoại đăng ký. Nhập OTP để hoàn tất giao dịch</p>
                </div>
              </div>

              <div className="mt-4 bg-blue-600 text-white p-4 rounded-lg">
                <p className="text-sm">
                  <strong>⚠️ Lưu ý:</strong> Khi thực hiện thanh toán, vui lòng chờ 2-3 giây, không đóng/tắt sớm 
                  trình duyệt hoặc app cho đến khi nhận được thông báo cuối cùng.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-lg">Hình thức 2: OnePay Card Domestic</h4>
              </div>
              
              <div className="space-y-3">
                <div className="flex gap-3">
                  <span className="text-green-600 font-bold">→</span>
                  <p className="text-sm text-gray-700">Chọn loại thẻ sử dụng để thanh toán (Thẻ ATM nội địa)</p>
                </div>
        ...
        <section className="bg-gradient-to-r from-gray-900 to-gray-700 text-white rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white/10 backdrop-blur rounded-lg p-6">
              ...
              <p className="text-sm text-gray-300 leading-relaxed">
                Mọi giao dịch thanh toán đều được mã hóa SSL 256-bit. Thông tin thẻ của bạn được bảo vệ 
                bởi chuẩn bảo mật quốc tế PCI-DSS.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-lg p-6">
              ...
              <a href="tel:0968877743" className="text-lg font-bold hover:text-gray-300">
                📞 096.88.777.43
              </a>
            </div>
          </div>
          ...
          <div className="text-center pt-6 border-t border-white/20">
            <p className="text-sm text-gray-300">
              Mọi thắc mắc về thanh toán, vui lòng liên hệ hotline hoặc gửi email: 
              <a href="mailto:support@beewo.vn" className="underline hover:text-gray-300 ml-1">
                support@beewo.vn
              </a>
            </p>
          </div>
